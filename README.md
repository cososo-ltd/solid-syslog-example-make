...
TIMESTAMP, HOSTNAME and APP-NAME are filled in from what the device already has: its wall clock,
its interface address, and its firmware name. PROCID stays nil — a bare-metal image has no process.

A record that says when it happened and which device it came from is the difference between a log
line and evidence.

<!-- STAGE-COST:START (generated by scripts/gen-cost-table.py — do not edit by hand) -->

**Cost above baseline: Flash +5,100 B, RAM +368 B.**
