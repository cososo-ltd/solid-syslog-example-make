...
/*                                                                        */
/* Vendored from ChaN FatFs R0.16 (FFCONF_DEF 80386), reflowed by            */
/* clang-format. The only deliberate change vs upstream is OS_TYPE 0 -> 3 to */
/* select the FreeRTOS branch.                                              */
/*------------------------------------------------------------------------*/
