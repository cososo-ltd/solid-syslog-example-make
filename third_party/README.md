...
| `solid-syslog` | no release yet | submodule | `a8d39793fc40a40987268bccccefbdc44f26f0b8` |
...
Apache-2.0, FatFs 1-clause BSD. SolidSyslog is offered under three alternative licences, which its
own [LICENSE.md](https://github.com/cososo-ltd/solid-syslog/blob/main/LICENSE.md) sets out.
